      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              href="#"
              className="inline-flex h-14 w-full items-center justify-center rounded-md bg-white px-8 text-sm font-semibold text-black transition-transform duration-300 hover:scale-105 sm:w-auto"
            >
              Start Deploying Now
            </a>
            <a
              href="#"
              className="inline-flex h-14 w-full items-center justify-center rounded-md border border-white/15 bg-white/5 px-8 text-sm font-semibold text-white backdrop-blur-md transition-colors hover:bg-white/10 sm:w-auto hover:scale-105 duration-300 transition-transform"
            >
              View Documentation
            </a>
          </div>
