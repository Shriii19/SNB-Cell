...
export function TrustStrip() {
  ...
  return (
    <section ref={containerRef} className="relative w-full overflow-hidden border-y border-gray-100 bg-white py-16 sm:py-20 lg:py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 mb-16">
            ...
            {metrics.map((metric, i) => {
              return (
                <motion.div
                  ...
                  key={metric.label}
                  className="group relative flex flex-col gap-2 rounded-2xl border border-gray-100 bg-white/60 p-6 backdrop-blur-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                >
